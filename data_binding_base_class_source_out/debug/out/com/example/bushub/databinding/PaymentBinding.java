...
public final class PaymentBinding implements ViewBinding {
  ...
  private PaymentBinding(@NonNull LinearLayout rootView, @NonNull TextView payment,
  ...
  public static PaymentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new PaymentBinding((LinearLayout) rootView, payment, textView1, textView2, textView3,
          textView4);
    }
