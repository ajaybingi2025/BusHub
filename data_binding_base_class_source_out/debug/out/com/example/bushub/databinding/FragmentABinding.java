...
public final class FragmentABinding implements ViewBinding {
  ...
  private FragmentABinding(@NonNull LinearLayout rootView, @NonNull TextView destination,
  ...
  public static FragmentABinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentABinding((LinearLayout) rootView, destination, textView1, textView2,
          textView3);
    }
