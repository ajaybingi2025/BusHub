...
public final class ActivityBusSeatsBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final TextView hyderabad;
  ...
  private ActivityBusSeatsBinding(@NonNull LinearLayout rootView, @NonNull Button confirm,
      @NonNull ImageView hamburgerMenu, @NonNull TextView hyderabad, @NonNull CheckBox seat1,
      ...
      @NonNull CheckBox seat9, @NonNull TextView timings) {
  ...
  @NonNull
  public static ActivityBusSeatsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityBusSeatsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_bus_seats, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityBusSeatsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.hyderabad;
      TextView hyderabad = ViewBindings.findChildViewById(rootView, id);
      if (hyderabad == null) {
        break missingId;
      }
      ...
      return new ActivityBusSeatsBinding((LinearLayout) rootView, confirm, hamburgerMenu, hyderabad,
          seat1, seat10, seat11, seat12, seat13, seat14, seat15, seat16, seat17, seat18, seat19,
          seat2, seat20, seat3, seat4, seat5, seat6, seat7, seat8, seat9, timings);
    }
