...
public class BookedTicketsWar extends AppCompatActivity {
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tickets_booked_wg);

        TextView selectionText = findViewById(R.id.selectionText2);
        TextView checkBoxSelections = findViewById(R.id.checkBoxSelections2);
