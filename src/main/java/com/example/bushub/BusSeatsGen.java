...
public class BusSeatsGen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bus_seats);
        ...
        submitButton = findViewById(R.id.confirm_);

        submitButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Create an intent to start the new activity
                Intent intent = new Intent(BusSeatsGen.this, BookedTicketsGen.class);
